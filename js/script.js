...
(function () {
    ...
    function showCategoryPage(categoryKey) {
        ...
        // Hide main sections, show category page
        ...
        // Scroll to top of category page
    ...
    function handleNavClick(e) {
        ...
        if (href && href.startsWith('#')) {
            // Check if category page is active
            if (categoryPage.classList.contains('active')) {
                hideCategoryPage();
                // Small delay to allow sections to reappear
                setTimeout(() => {
    ...
    function init() {
        ...
        // Home link - also hides category page
